...
export const bazaarData: BazaarItems = [
  {
    ...
    items: [
      { name: "Iron", price: 210, unit: "G", category: "Ore", unlockWhen: "Bazaar Rank 3" },
      { name: "Copper", price: 700, unit: "G", category: "Ore", unlockWhen: "Bazaar Rank 3" },
      { name: "Silver", price: 1120, unit: "G", category: "Ore", unlockWhen: "Bazaar Rank 3" },
      { name: "Gold", price: 2800, unit: "G", category: "Ore", unlockWhen: "Bazaar Rank 4" }
    ]
  },
  {
    name: "Isaac's Stall",
    ...
    items: [
      ...
      },
      {
        ...
        unit: "G",
        category: "Expansion",
        notes: "Clears east side of pasture; room for another barn. Takes 3 days."
      },
      {
  ...
  {
    name: "Garon's Stall",
    description: "Sells soil upgrades, storage freshness power-ups, cooking tools, bath upgrade, and barn construction.",
    items: [
      {
      ...
      },
      {
        ...
        unit: "G",
        category: "Upgrade",
        notes: "Improves soil for significantly higher quality crops. Takes 2 days."
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        unit: "G",
        category: "Pet",
        notes: "Fast travel, racing. Limit: 1. Unlock: Autumn 2, Year 1 (free from Ramón)."
      }
    ]
  },
  {
    name: "Sprite Stall",
    description: "Trades Energy for warp boxes, power berries, decorations, recipes, and basic resources/seeds.",
    items: [
      { name: "Spirit Box: Bazaar", price: 5000, unit: "Energy", category: "Warp", notes: "Warp Storage Box" },
      { name: "Spirit Box: Zephyr Town", price: 20000, unit: "Energy", category: "Warp", notes: "Warp Storage Box" },
      { name: "Spirit Box: Red Windmill", price: 5000, unit: "Energy", category: "Warp", notes: "Warp Storage Box" },
      { name: "Spirit Box: Mountains", price: 50000, unit: "Energy", category: "Warp", notes: "Warp Storage Box" },
      { name: "Power Berry", price: 10000, unit: "Energy", category: "Power Berries" },
      { name: "Leaf Tent", price: 6000, unit: "Energy", category: "Decoration" },
      { name: "Leaf Counter", price: 5000, unit: "Energy", category: "Decoration" },
      { name: "Nature Sprite Gift", price: 4500, unit: "Energy", category: "Decoration" },
      { name: "Happy Forest Mix", price: 1000, unit: "Energy", category: "Recipe" },
      ...
      { name: "Turnip Seed", price: 1000, unit: "Energy", category: "Crop Seeds" },
      { name: "Strawberry Seed", price: 1000, unit: "Energy", category: "Crop Seeds" },
      { name: "Rice Seed", price: 1000, unit: "Energy", category: "Crop Seeds" },
      { name: "Soybean Seed", price: 1000, unit: "Energy", category: "Crop Seeds" },
      { name: "Wheat Seed", price: 1000, unit: "Energy", category: "Crop Seeds" },
