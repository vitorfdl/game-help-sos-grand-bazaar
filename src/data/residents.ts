...
export const residents: Resident[] = [
  ...
  { name: 'Lloyd', group: 'Bachelors', favorite: 'Paella', likes: ['Fondues', 'Bugs', 'Juices'], birthday: { season: 'Autumn', day: 3 } },
  ...
  { name: 'Stuart', group: 'Villagers', favorite: 'Mont Blanc', likes: ['Noodles', 'Teas', 'Pickles'], birthday: { season: 'Autumn', day: 11 } },
