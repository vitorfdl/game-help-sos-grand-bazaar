...
export const residents: Resident[] = [
  ...
  { name: 'Lloyd', group: 'Bachelors', favorite: 'Paella', likes: ['Fondues', 'Bugs', 'Juices'] },
  { name: 'Gabriel', group: 'Bachelors', favorite: 'Omelet Rice', likes: ['Gratin', 'Fruit Dishes', 'Sweets'], birthday: { season: 'Winter', day: 28 } },
  { name: 'Samir', group: 'Bachelors', favorite: 'Stew', likes: ['Rice', 'Rice Dishes', 'Stag Beetles'] },
  ...
  { name: 'Maple', group: 'Bachelorettes', favorite: 'Engadin Nut Tart', likes: ['Sweets', 'Flowers', 'Butterflies'], birthday: { season: 'Autumn', day: 14 } },
  { name: 'Kagetsu', group: 'Bachelorettes', favorite: 'Tofu Pudding', likes: ['Tofu Dishes', 'Vegetable Dishes', 'Crops'], birthday: { season: 'Spring', day: 5 } },
  ...
  { name: 'Stuart', group: 'Villagers', favorite: 'Mont Blanc', likes: ['Noodles', 'Teas', 'Pickles'] },
  { name: 'Sonia', group: 'Villagers', favorite: 'Fruits Mochi', likes: ['Juices', 'Teas', 'Wild Herbs'], birthday: { season: 'Spring', day: 25 } },
